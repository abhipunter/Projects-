...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        """
        self.room=room
        self.r=room.getRandomPosition()
        self.speed=speed
        self.d=random.randint(0,360)
        self.room.cleanTileAtPosition(self.r)
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        """
        #old=Position()
        new=self.r.getNewPosition(self.d, self.speed)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    tri=[]
    def sim():
        anim = ps2_visualize.RobotVisualization(num_robots, width, height,delay=.5)
        time=0
        ...
        while i<=num_robots:
            l.append(robot_type(room,speed))
            i+=1
        
        cover=num_robots/room.getNumTiles()
        
        while cover<min_coverage:
            
              time+=1
              
              for i in l:
                  i.updatePositionAndClean()
              cover=room.getNumCleanedTiles()/room.getNumTiles()
              anim.update(room, l)
        return time
    for trials in range(1,num_trials+1):
        tri.append(sim())
        anim.done()
    return sum(tri)/num_trials
...
#print(runSimulation(10, 1.0, 10, 10,1, 30, RandomWalkRobot))
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        new=self.room.getRandomPosition()
...
#       (... your call here ...)
#
#d=Robot(RectangularRoom(4,6),1.0)
#